...
// moway_project.cpp: define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CmowayprojectApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CmowayprojectApp

CmowayprojectApp::CmowayprojectApp()
{
...
// Único objeto CmowayprojectApp

CmowayprojectApp theApp;


// Inicialización de CmowayprojectApp

BOOL CmowayprojectApp::InitInstance()
{
